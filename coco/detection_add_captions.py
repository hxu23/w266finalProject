...
train_val_info = json.load(open('coco_raw.json', 'r'))
...
test_info = json.load(open('annotations/image_info_test2014.json', 'r'))['images']
testfilename2id = {info['file_name']:info['id'] for info in test_info}

detection_result = list(map(json.loads, open('coco_detection_result', 'r').readlines()))
