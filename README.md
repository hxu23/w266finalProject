...
To generate `cocotalk_objname_location.h5` thant contains [YOLO2](https://pjreddie.com/darknet/yolo/) detected object names, locations, and original COCO captions:
